...
### 第二章 内容发布与知识产权
#### 一、社区开源协议
本社区平台代码遵循 **AGPL-3.0许可证**

#### 二、用户内容许可规则
1.  **代码/项目类内容**：  
    - ✅ **强烈建议** 上传时声明开源许可证（如MIT、GPL等）；  
    - ⚠️ **未声明许可证** 的内容，我们视为保留所有权利；  
    - 其他用户可在遵守对应许可证前提下**学习、修改、分发**您的代码。
    - 所有许可证的信息由您上传控件到[[CoCo-Community-Control](https://github.com/zitzhen/CoCo-Community-Control)]中文件夹的`README.md`与`LICENSE`文件为准。
