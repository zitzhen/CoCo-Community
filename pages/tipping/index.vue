        ...
        <div class="payment-methods">
            <div class="method" :class="{ active: activeMethod === 'wechat' }" data-method="wechat" @click="setActiveMethod('wechat')">
                <div class="method-icon">
                    <img :src="wechatPayLogo" alt="微信支付">
                </div>
...
import alipayQr from '@/assets/images/tipping/Alipay.png'
import alipayLogo from '@/assets/images/tipping/Alipaylogo.png'
import qqLogo from '@/assets/images/tipping/QQlogo.png'
import qqPayQr from '@/assets/images/tipping/QQpay.png'
import wechatPayQr from '@/assets/images/tipping/Wechatpay.png'
import wechatPayLogo from '@/assets/images/tipping/WechatPaylogo.png'
